...
Tu paquete se llama `@dmorapedregosa/j38-lib` (con scope).

- Verifica que el nombre esté disponible: https://www.npmjs.com/package/@dmorapedregosa/j38-lib
...
1. Ve a: https://www.npmjs.com/package/@dmorapedregosa/j38-lib
...
```bash
npm install @dmorapedregosa/j38-lib
```
